...
public class SudokuValidatorTest {
    ...
    @Test
    public void testInValidCompletedPuzzle() {
        // Fill a valid completed puzzle
        int[][] solution = {
                {5, 3, 4, 6, 7, 8, 9, 1, 2},
                {6, 7, 2, 1, 9, 5, 3, 4, 8},
        ...
        assertThat(errors).isNotEmpty();
        assertThat(errors.get(0).getMessage()).contains("8 already exists in Row E");
    }

    @Test
    public void testCellClearingIfCheckViolates() {
        // Fill a valid completed puzzle
        int[][] solution = {
                {5, 3, 4, 1, 7, 8, 9, 1, 2},
                {6, 7, 2, 1, 9, 5, 3, 4, 8},
        ...
        assertThat(errors).isNotEmpty();
        assertThat(errors.get(0).getMessage()).contains("clearing the cell");
        assertThat(grid.getCell(4, 6).isEmpty()).isTrue();
    }
}
